...
>>>>>>> xutian push
  public:
    ...
    int  splitter(int argc, char *argv[]);
    void init();
    void show();
    void coord(unsigned index);
    ...
    void coordeditFile(unsigned index);
...
=======
    ...
    void on_sscdConnect(double  str);
...
<<<<<<< HEAD
    void on_actionShowCorner_triggered(bool checked);
=======
...
<<<<<<< HEAD
=======
    void on_actionAlgorithm_Mode_clicked();
    void on_actionShowCorner_triggered(bool checked);
